    ...
    <div className="rounded-xl border border-gray-200 bg-white overflow-hidden dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="relative px-4 pb-4">
        ...
        <div className="absolute -top-12 left-4 sm:-top-16">
          <div className="h-24 w-24 rounded-full border-4 border-white bg-gray-200 dark:border-gray-900 dark:bg-gray-700 sm:h-32 sm:w-32">
            {profile.avatar_url ? (
              <img
              ...
              <div className="flex h-full w-full items-center justify-center rounded-full bg-primary-100 text-3xl font-bold text-primary-600 dark:bg-primary-900 dark:text-primary-400 sm:text-4xl">
        ...
        <div className="flex justify-end pt-4">
          {isOwnProfile ? (
            <button
              type="button"
              className={cn(
                "rounded-full border border-gray-300 px-4 py-2 font-semibold text-gray-900",
                "hover:bg-gray-50 dark:border-gray-700 dark:text-gray-100 dark:hover:bg-gray-800"
              )}
            >
              Edit profile
            </button>
